...
export const meta = {
  title: "Getting your Wallet Ready for ITO tokens",
  publishDate: "2020-01-27T00:00:00+08:00",
  image: step1
};

> If you’re reading this article, I assume you are familiar with the In Time
> Foundation and their ICO (Initial Coin Offering) of ITO Tokens, and are
> interested in acquiring some for your own investment or for re-selling.
>
> Read my previous article on ITOto learn more.

In this post, I will outline the steps needed to get ready to be a token
holder or private seller of the ITO tokens from the new ICO of the In Time
Foundation.
...
allow users to store Ether and other Ethereum tokens (such as ITO tokens).
There are many wallets available for your desktop PC, Android or iOS devices.
Currently, the only wallet that has complete support of ITO tokens is Trust
Wallet.
...
Next, you need to set up your Trust Wallet to receive ITO tokens. This part
has 2 steps, the first step is to create your wallet, the second is to add ITO
...
## Add ITO to list of managed tokens

As you can see from the image above, your wallet lists 3 coins by default:
Ethereum, Bitcoin and BNB. We’re interested in Ethereum and ITO.

So the last step is to add ITO tokens to this list:
...
If you plan on re-selling your ITO tokens privately, you need to acquire a
...
# 04 | Acquire ITO Tokens

I assume you are already a holder of ITO tokens, acquired locally from
