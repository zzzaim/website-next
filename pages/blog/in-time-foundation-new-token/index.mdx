...
export const meta = {
  image,
  title: "In Time Foundation and a new multi-foundation token",
  publishDate: "2020-01-24T00:00:00+08:00"
};

<img {...image} />

> The In Time foundation is an organisation that has launched a new ICO
> (Initial Coin Offering). This is a quick look at their offering of ITO
> Ethereum tokens.
...
In Time tokens, outlining their plan, and how they are different from the
...
# The In Time Foundation

This brings us to the In Time Foundation. The organisation is offering a new
Ethereum token, namely ITO.
...
## What makes ITO tokens different?

In contrast to most other ICOs, ITO tokens do not provide a single specific
...
This foundation focuses on projects in the Bio-Science, Education, Food &
Beverage and Philanthropic fields, with the objectives of:

1. Helping underprivileged orphans.
2. Providing affordable education and skills training.
3. Contributing to sustainable food production and natural resource
   management.
4. Contributing to bio-science / pharmaceutical research and application.
5. Providing easy access to health care.
6. Maintaining a stable and liquid currency.

Their roadmap is divided into 3 five-year phases:

1. **Phase 1 (2020–2024): Global Education Ltd.** Projects include the
   acquisition of two US-based online education groups, establishing an
   Induced pluripotent stem cell (iPSC) research lab, and sponsoring five
   orphans to boarding school in Calgary and Alberta, among others. Target
   IPO: USD 55B at USD 4/share.
2. **Phase 2 (2025–2029): Food & Beverages Ltd.** Includes projects such as
   the acquisition of F&B groups of companies, establishing mineral water
   plants, and large scale urban farming in 100 cities. Target IPO: USD 200B
   at USD8/share.
3. **Phase 3 (2030–2034): Hospitals & Pharmaceuticals Ltd.** Projects include
   mass production and global distribution of induced pluripotent stem cells
   (iPSCs), and establishing hospitals, pharmaceutical plants, and pharmacies
   across 100 cities. Target IPO: USD 1T at USD 8/share.

# What to expect next

These are some technical questions related to the usage of the underlying
Ethereum blockchain used by ITO tokens, you may skip this section if you’re
...
- The In Time Foundation is offering a new Ethereum token: ITO
...
In Time Whitepaper:
[intimefoundation.org](https://intimefoundation.org){rel="external"}
